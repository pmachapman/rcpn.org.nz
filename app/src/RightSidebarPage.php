...
namespace {
	...
	class RightSidebarPage extends Page
	{
		...
		private static $has_one = array(
			...
			'MiddleSidebarUrl' => SiteTree::class,
		...
		public function getCMSFields()
		{
			...
			$fields->addFieldToTab('Root.Main', new TreeDropdownField("MiddleSidebarUrlID", "Link Button To Page", SiteTree::class), 'Metadata');
	...
	class RightSidebarPageController extends PageController
	{
	}
}
